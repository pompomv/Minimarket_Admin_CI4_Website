...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div></div>
    <a href="/suppliers/add" class="btn btn-primary"><i class="bi bi-plus-circle me-2"></i>Tambah Supplier</a>
</div>

<div class="table-card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <span><i class="bi bi-truck me-2"></i>Daftar Supplier (<?= count($suppliers) ?>)</span>
        <input type="text" id="searchBox" class="form-control form-control-sm w-auto" placeholder="Cari supplier…" style="min-width:200px">
    </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/suppliers/destroy/<?= esc($s['id']) ?>" class="btn btn-sm btn-outline-danger py-0"
                           onclick="return confirm('Hapus supplier ini?')"><i class="bi bi-trash"></i></a>
                    </td>
                </tr>
                <?php endforeach; ?>
